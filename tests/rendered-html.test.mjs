...
test("ships the approved wedding photo and cool-neutral theme", async () => {
  ...
  assert.match(sourceHtml, /app\.js\?v=20260904-welcome-copy/);
  ...
  assert.doesNotMatch(sourceConfig, /与亲友相见、聊天、拍照。/);
  ...
  assert.match(sourceConfig, /assetVersion:\s*"20260904-welcome-copy"/);
